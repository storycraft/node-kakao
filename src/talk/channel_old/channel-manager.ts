...
import { ChatUser, DisplayUserInfo } from "../user_old/chat-user";
import { PacketCreateChannelRes, PacketCreateChannelReq } from "../../packet_old/packet-create-channel";
import { PacketChannelInfoReq, PacketChannelInfoRes } from "../../packet_old/packet-channel-info";
import { ChannelInfoStruct } from "../struct_old/channel-info-struct";
import { ChannelDataStruct } from "../struct_old/channel-data-struct";
import { PacketLeaveRes, PacketLeaveReq } from "../../packet_old/packet-leave";
import { ChannelType } from "./channel-type";
import { StatusCode } from "../../packet_old/loco-packet-base";
import { PacketChatOnRoomReq, PacketChatOnRoomRes } from "../../packet_old/packet-chat-on-room";
import { PacketMessageNotiReadReq } from "../../packet_old/packet-noti-read";
import { PacketUpdateChannelRes, PacketUpdateChannelReq } from "../../packet_old/packet-update-channel";
import { PacketSetMetaReq, PacketSetMetaRes } from "../../packet_old/packet-set-meta";
import { ChannelMetaType, ChannelClientMetaType, ChannelMetaStruct, PrivilegeMetaContent, ProfileMetaContent, TvLiveMetaContent, TvMetaContent, LiveTalkCountMetaContent, GroupMetaContent, BotMetaContent } from "../struct_old/channel-meta-struct";
import { PacketSetClientMetaRes, PacketSetClientMetaReq } from "../../packet_old/packet-set-client-meta";
import { PacketGetMetaRes, PacketGetMetaReq, PacketGetMetaListReq, PacketGetMetaListRes } from "../../packet_old/packet-get-meta";
import { ChannelSettings } from "./channel-settings";
import { PacketJoinLinkReq, PacketJoinLinkRes } from "../../packet_old/packet-join-link";
import { OpenProfileType, OpenLinkType } from "../open_old/open-link-type";
import { OpenLinkTemplate } from "../open_old/open-link-template";
import { PacketCreateOpenLinkReq, PacketCreateOpenLinkRes } from "../../packet_old/packet-create-open-link";
...
import { ManagedChatChannel, ManagedOpenChatChannel, ManagedMemoChatChannel, ManagedDisplayUserInfo, ManagedNormalChatChannel } from "../managed_old/managed-chat-channel";
import { RequestResult } from "../../request/request-result";
import { OpenProfileTemplates } from "../open_old/open-link-profile-template";
import { PacketAddMemberReq, PacketAddMemberRes } from "../../packet_old/packet-add-member";
import { PacketKickLeaveReq, PacketKickLeaveRes } from "../../packet_old/packet-kick-leave";
import { JsonUtil } from "../../util/json-util";
import { PacketCheckJoinReq, PacketCheckJoinRes } from "../../packet_old/packet-check-join";
import { PacketGetMemberReq, PacketGetMemberRes } from "../../packet_old/packet-get-member";
import { PacketMemberReq, PacketMemberRes } from "../../packet_old/packet-member";

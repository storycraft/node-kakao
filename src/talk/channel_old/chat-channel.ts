import { ChatUser, UserInfo, OpenChatUserInfo, ChatUserInfo, DisplayUserInfo, NormalChatUserInfo } from "../user_old/chat-user";
...
import { PrivilegeMetaContent, ProfileMetaContent, TvMetaContent, TvLiveMetaContent, LiveTalkCountMetaContent, GroupMetaContent, ChannelMetaStruct, ChannelMetaType, BotMetaContent } from "../struct_old/channel-meta-struct";

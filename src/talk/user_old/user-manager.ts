...
import { PacketGetMemberRes, PacketGetMemberReq } from "../../packet_old/packet-get-member";
...
import { ManagedChatUser, ManagedChatUserInfo, ManagedOpenChatUserInfo } from "../managed_old/managed-chat-user";

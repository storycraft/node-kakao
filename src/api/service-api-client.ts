...
export class ServiceApiClient {
     ...
     * @param since Unknown
     */
    async requestLessSettings(since: number = 0): AsyncCommandResult<LessSettingsStruct> {
        const res = await this._client.request(
            'GET',
    ...
    async addFriend(id: Long, pa: string = ''): AsyncCommandResult<FriendReqStruct> {
    ...
    async hideFriend(id: Long, pa: string = ''): AsyncCommandResult {
